...
SELECT
    v.vendor_name,
    p.product_name,
    ROUND(SUM(5 * vi.original_price), 2) AS total_revenue
FROM (
    SELECT DISTINCT
        vendor_id,
        product_id,
...
VALUES
    (100, 'Apple Pie', 'Large', 3, 'unit', CURRENT_TIMESTAMP);
...
SET current_quantity = (
    ...
    ORDER BY market_date DESC --takes the most recent market day for product qty
    LIMIT 1
);
